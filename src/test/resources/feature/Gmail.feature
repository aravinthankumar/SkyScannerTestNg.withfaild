@step1
Feature: To validate the create account functionality gmail application

Scenario: To validate the create account functionality of gmail step1 application
